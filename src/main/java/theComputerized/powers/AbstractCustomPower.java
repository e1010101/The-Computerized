...
import theComputerized.util.TexLoader;
...
public abstract class AbstractCustomPower extends AbstractPower {
    ...
    public AbstractCustomPower(String NAME, PowerType powerType, boolean isTurnBased, AbstractCreature owner, int amount) {
        ...
        Texture normalTexture = TexLoader.getTexture(
            Main.modID + "Resources/images/powers/" + NAME.replaceAll("([ ])", "") + "32.png");
        Texture hiDefImage = TexLoader.getTexture(
            Main.modID + "Resources/images/powers/" + NAME.replaceAll("([ ])", "") + "84.png");
        if (hiDefImage != null) {
